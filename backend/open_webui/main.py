...
app.state.config.JINA_ENHANCED_SEARCH_ENABLED = JINA_ENHANCED_SEARCH_ENABLED
app.state.config.JINA_STRICT_AUTHORITY_MODE = JINA_STRICT_AUTHORITY_MODE
app.state.config.JINA_MAX_CANDIDATES = JINA_MAX_CANDIDATES
app.state.config.JINA_MAX_EVIDENCE_ITEMS = JINA_MAX_EVIDENCE_ITEMS
app.state.config.JINA_ENABLE_OPTIONAL_RERANK = JINA_ENABLE_OPTIONAL_RERANK
app.state.config.JINA_OUTPUT_MODE = JINA_OUTPUT_MODE
